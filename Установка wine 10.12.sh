...
winetricks -q dxvk vcrun2022 isolate_home sandbox  faudio andale arial comicsans courier georgia impact times trebuchet verdana webdings corefonts calibri physx tahoma lucida 7zip openal vcrun2008 vcrun2010 vcrun2012 vcrun2013 baekmuk cambria candara consolas constantia corbel droid eufonts ipamona liberation meiryo micross opensymbol sourcehansans takao uff unifont vlgothic wenquanyi wenquanyizenhei allfonts pptfonts directplay remove_mono winxp dotnet40 gdiplus gdiplus_winxp riched30 richtx32 fakechinese fakejapanese fakekorean cjkfonts
winetricks
#
# Настройка Wine
winecfg
