...
функция — переключение светлой/тёмной темы YouTube. В 2026-09-24 тема объединена
в расширение Enhancer for YouTube (`js/ma-content.js`, `js/ma-main-world.js`,
`css/ma.css` — см. `../Enhancer for YouTube/README-CUSTOM.md`, §3); кастомная
папка Magic Actions больше не нужна. Полное объяснение с историей всех находок
и багов — в «Как работает Magic Actions for YouTube.md». Файлы оригинала
(`esw30.js`, `gjs30/`, `gcss30/`, `e*.html`) не подключены в manifest.json
...
С 2026-09-24 расширение больше не устанавливается отдельно: вся тема живёт
в Enhancer for YouTube (папка `../Enhancer for YouTube/`), там же — тумблер
в popup и скрипт упаковки в .crx.
