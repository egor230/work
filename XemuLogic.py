...
class XemuConfigManager:
    ...
    def __init__(self):
        ...
        # USB HID Keyboard Usage IDs (полная таблица для XEMU)
        self.scancodes = {
            # === Буквы ===
        ...
        self.default_mapping = {
            ...
            "btn_x": 89,         # x
            "btn_y": 229,        # y
            "dpad1_left": 13,    # dpad_left
            "dpad1_up": 12,      # dpad_up
            "dpad1_right": 15,   # dpad_right
            "dpad1_down": 14,    # dpad_down
            "back": 90,          # back/select
            "start": 87,         # start
            "white": 92,         # white
            "black": 94,         # black
            "lstick_btn": 97,    # lstick_btn
            "rstick_btn": 85,    # rstick_btn
            "guide": 86,         # guide
            "dpad2_up": 82,      # lstick_up
            "dpad2_left": 80,    # lstick_left
            "dpad2_right": 79,   # lstick_right
            "dpad2_down": 81,    # lstick_down
            "ltrigger": 91,      # ltrigger
            "rtrigger": 99,      # rtrigger
        }
    ...
    def export_xemu_config(self, filepath):
        ...
        new_bindings = []
        # Используем порядок из default_mapping для сохранения последовательности
